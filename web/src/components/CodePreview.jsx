  ...
  return (
    <div className="code-preview">
      ...
      <div className="code-info">
        ...
        <p className="code-info-sub">Program and Live control run by sending MQTT commands to the firmware already on the robot. One-time USB firmware setup is in the Setup tab.</p>
      </div>
